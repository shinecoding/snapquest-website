...
const FEATURES = [
  ...
  },
  {
    ...
    children:
      "Our AI system watches your pattern over time, so one faked snap can't game the system. Suspicious activity gets flagged for human review, keeping every quest fair and honest.",
  },
  {
    icon: CameraIcon,
  ...
  },
  {
    ...
    children:
      "Your quest members are not just bystanders. They share the same goal and commitment that you have. That means they have every reason to watch you closely and call you out when you slip.",
  },
];
